...
export function ProductDetailClient({
  ...
  const hasItemsFromOtherStore =
    items.length > 0 && items.some((item) => item.storeId !== store?.id);
          ...
          <div className='flex flex-col justify-center'>
            <div className='mb-4 sm:mb-6'>
              ...
              <p className='text-sm sm:text-base lg:text-lg text-slate-600 dark:text-slate-400 leading-relaxed mb-6 sm:mb-8'>
                {product.description ||
                  'Delicioso producto disponible para entrega a domicilio.'}
              </p>
            </div>

            <div className='space-y-4 sm:space-y-6 mb-6 sm:mb-8'>
              <div>
                <label className='block text-xs font-bold uppercase tracking-wider text-slate-500 mb-3 sm:mb-4'>
                  Cantidad
                </label>
